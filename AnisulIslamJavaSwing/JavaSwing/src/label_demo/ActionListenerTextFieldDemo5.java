...
public class ActionListenerTextFieldDemo5 extends JFrame {

    private Container c;
    private JTextField tf1, tf2;

    ActionListenerTextFieldDemo5() {
        initComponents();
    }
    ...
    public static void main(String[] args) {
        ...
        ActionListenerTextFieldDemo5 frame = new ActionListenerTextFieldDemo5();
