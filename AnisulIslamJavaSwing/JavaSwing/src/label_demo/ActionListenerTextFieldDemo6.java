...
public class ActionListenerTextFieldDemo6 extends JFrame {

    private Container c;
    private JTextField tf1, tf2;

    ActionListenerTextFieldDemo6() {
        initComponents();
    }
    ...
    public static void main(String[] args) {
        ...
        ActionListenerTextFieldDemo6 frame = new ActionListenerTextFieldDemo6();
