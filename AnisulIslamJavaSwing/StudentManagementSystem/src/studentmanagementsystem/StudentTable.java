            ...
            public void mouseClicked(MouseEvent me)
                {
                    ...
                    String f_name = model.getValueAt(numbetOfRow, 0).toString();
                    String l_name = model.getValueAt(numbetOfRow, 1).toString();
                    String phone = model.getValueAt(numbetOfRow, 2).toString();
                    String gpa = model.getValueAt(numbetOfRow, 3).toString();
